...
<div class="navbar">
    <div class="navbar-inner">
        <div class="container-fluid" style="background-color: #9196d3">
            <a href="#" class="brand" >
                <small style="font-size: 26px; font-weight: bold;line-height: 40px;">
                    好再来酒店管理系统
                    <span style="font-size: 17px;">Good Recur Hotel Guestroom Management System</span>
                </small>
            </a>
    ...
    padding-left: 23px;">菜单</h4>
        ...
        <ul class="nav nav-list">
            ...
            <li>
                ...
                <ul class="submenu">
                    <li>
                        <a id="userInfoId" onclick="userInformation()" href="#">
                            <i class="icon-double-angle-right"></i>
                            <span>管理员信息 </span>
                        </a>
                    </li>
