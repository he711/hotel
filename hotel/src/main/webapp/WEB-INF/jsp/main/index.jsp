...
<div class="container" style="height:1000px;pxoverflow-x:auto;background-color: rgb(255 255 255 / 45%)">

    <div class="span11" style=" border: solid; border-color: #DDDDDD;">
        <div class="span9 margin-top-one">
            <div class="row-fluid">
                <h3 style="text-align: center;color: rgba(0,54,190,0.79);margin-top: 15px">好再来酒店管理系统</h3>
            </div>
            <h3 style="text-align: right;">
                <button style="width: 100px;height: 50px; text-align: center; font-size: 25px;" onclick="login()">登录</button>
            </h3>
        </div>
        ...
        <form id="form1" method="post">
            ...
            <div class="span12" style="display: flex; justify-items: center;align-items: center;">
                <div class="row-fluid">
                    <div class="span3">
                        <label>房间号：</label>
